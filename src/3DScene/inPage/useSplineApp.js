...
import CaptPage from './CaptureWeb/CaptPage'
    ...
    <div ref={container} className="content-container">
      ...
      <Canvas
        ...
        <group onClick={(e) => (e.stopPropagation(), setUseCamera(!useCamera))}>
          <IPhoneSE open={useCamera} portal={domContent} position={[0, -50, 0]} />
        </group>
      </Canvas>
    </div>
  )
...
export function IPhoneSE({ open, portal, ...props }) {
  let timeout = null
  ...
  useFrame((state) => {
    ...
    state.camera.position.lerp(v.set(0, 0, -32), 0.1)
      ...
      <FloatImpl floatIntensity={100} rotationIntensity={0.5} speed={1}>
        ...
        <group position={[0, -50, 0]} rotation={[-0.15, 0, 0]}>
          ...
          <three.group
            ...
            name="phone" position={[open ? 180 : -50, 0, -68]}>
