...
export default function IPhone13({ ready, app, open=false, ...props }) {
  ...
  useFrame((state) => {
    ...
    // state.camera.position.lerp(vec.set(0, 0, =false ? -20 : -32), 0.1)
      ...
      <group name="iPhone 13 Pro" position={[0, 0, 0]} rotation={[0, 0.02, 0]}>
        <group name="Body" position={[90.66, -103.81, 35.71]} scale={[1.02, 1.02, 1.04]}>
          <mesh
            ...
            {app === "bike" && <meshBasicMaterial clearcoat={1} clearcoatRoughness={0} toneMapped={false}>
              <videoTexture
                attach="map"
                args={[video]}
                flipY={true}
            ...
            {app === "MyLog" && <meshBasicMaterial   clearcoat={1} clearcoatRoughness={0} toneMapped={false}>
              <videoTexture
